...
public class Homework5 {
    ...
    private void testCreateSave() throws IOException, URISyntaxException, InvalidDataException {
        ...
        addCommand1.execute();
        addCommand2.execute();
        var saveCommand = new SaveCommand(catalog, "/Users/stefanbodescu/Desktop/Homework5/catalog.json");
        saveCommand.execute();
    }
    ...
    private void testLoadView() throws InvalidCatalogException, IOException, URISyntaxException, InvalidDataException {
        ...
        var loadCommand = new LoadCommand(catalog, "/Users/stefanbodescu/Desktop/Homework5/catalog.json");
